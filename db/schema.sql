...
CREATE TYPE "lang_iso2"
    AS ENUM ('ru', 'en', 'es');

--
--

CREATE SEQUENCE "phrase_id_seq" INCREMENT BY 50 START 10700000;

CREATE TABLE "phrase"
(
    "phrase_id"      int PRIMARY KEY      DEFAULT nextval('phrase_id_seq'),
    "language"       lang_iso2   NOT NULL,
...
CREATE SEQUENCE "translation_id_seq" INCREMENT BY 50 START 100000;
...
CREATE SEQUENCE "pronunciation_id_seq" INCREMENT BY 50 START 500000;
...
CREATE SEQUENCE "book_id_seq" INCREMENT BY 50 START 1030600;
...
CREATE SEQUENCE "book_phrase_id_seq" INCREMENT BY 100 START 900000;
...
CREATE SEQUENCE "unexpected_word_id_seq" INCREMENT BY 50 START 50000;
...
CREATE SEQUENCE "user_id_seq" INCREMENT BY 50 START 30000050;
...
CREATE SEQUENCE "user_book_id_seq" INCREMENT BY 50 START 200;
...
CREATE SEQUENCE "user_phrase_id_seq" INCREMENT BY 50 START 1050000;
...
CREATE SEQUENCE "search_attempt_id_seq" INCREMENT BY 50 START 200;
